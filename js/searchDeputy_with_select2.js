...
(function(){
	...
	function showMapRegionHover(){
		...
		if( container.length ){
			$('.reg.hasHover').mouseover(function(){
				...
				var y = ($(this)[0].getBBox().y + 45).toFixed(0);
	...
	//function deputySearchSteps(){
		...
		function requestDepartmentLocal(){
			//console.log('requestDepartmentLocal')
			form.html('<div>'+
		...
		// $('#ukraineMap .reg').click(function(){
			// console.log($(this))
			// $('.deputy_search').trigger('change', '.action_container[data-step="1"] input[type="radio"]')
		// })
